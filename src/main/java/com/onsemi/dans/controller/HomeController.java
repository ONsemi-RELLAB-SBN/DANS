...
public class HomeController {
    ...
    public String home(
        ...
        LOGGER.info("LOGGER for Login User Session : " + userSession);
...
//        model.addAttribute("countTtShip", countTtShip);
    ...
    public String loginError(
        ...
        redirectAttrs.addFlashAttribute("error", messageSource.getMessage("general.label.login.ldaperror", args, locale));
        return "redirect:/";
    }
