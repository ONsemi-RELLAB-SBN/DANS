...
//    hold for now
//    @Scheduled(cron = "0 0 8 * * *") //every 8.00am disable it for now. inactive!
...
//    @Scheduled(cron = "0 2 8 * * *") //every 8.00am disable for now. active
...
//                String reportName = "C:\\Users\\" + username + "\\Documents\\CDARS\\MP_expiry\\[HIMS] Material Pass Expire Within 30 Days (" + todayDate + ").xls";
                String reportName = "\\\\mysed-rel-app03\\d$\\HIMS\\RL\\MP_expiry\\[HIMS] Material Pass Expire Within 30 Days (" + todayDate + ").xls";
...
//                
                ...
                emailSender.htmlEmailWithAttachment(
                        ...
                        new File("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\MP_expiry\\[HIMS] Material Pass Expire Within 30 Days (" + todayDate + ").xls"),
                        //                    subject
...
//    @Scheduled(cron = "0 0 8 * * *") //every 8.00am //disable for now. active
...
//                String reportName = "C:\\Users\\" + username + "\\Documents\\CDARS\\MP_expiry\\[HIMS] Material Pass Has Expired(" + todayDate + ").xls";
                String reportName = "\\\\mysed-rel-app03\\d$\\HIMS\\RL\\MP_expiry\\[HIMS] Material Pass Has Expired(" + todayDate + ").xls";
...
//                
                ...
                emailSender.htmlEmailWithAttachment(
                        ...
                        new File("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\MP_expiry\\[HIMS] Material Pass Has Expired(" + todayDate + ").xls"),
                        //                    subject
