...
//import com.onsemi.dans.dao.CardPairingDAO;
//import com.onsemi.dans.dao.WhInventoryDAO;
//import com.onsemi.dans.dao.WhMpListDAO;
//import com.onsemi.dans.dao.WhRequestDAO;
//import com.onsemi.dans.dao.WhRetrievalDAO;
//import com.onsemi.dans.dao.WhShippingDAO;
//import com.onsemi.dans.dao.WhStatusLogDAO;
//import com.onsemi.dans.model.CardPairing;
//import com.onsemi.dans.model.CardPairingTemp;
//import com.onsemi.dans.model.WhBibCardCsvTemp;
//import com.onsemi.dans.model.WhEqptCsvTemp;
//import com.onsemi.dans.model.WhInventory;
//import com.onsemi.dans.model.WhInventoryTemp;
//import com.onsemi.dans.model.WhRequest;
//import com.onsemi.dans.model.WhRetrieval;
//import com.onsemi.dans.model.WhRetrievalTemp;
//import com.onsemi.dans.model.WhShipping;
//import com.onsemi.dans.model.WhStatusLog;
import com.onsemi.dans.tools.QueryResult;
import com.onsemi.dans.tools.SPTSResponse;
import com.onsemi.dans.tools.SPTSWebService;
...
//            + "requestor_email,rack,shelf";
    private static final String HEADER = "id,eqpt_type,eqpt_id,quantity,box_no,gts_no,requested_by,"
            + "requestor_email,rack,shelf";
...
//            + "requestor_email,rack,shelf";
    private static final String HEADER_CARD = "id,eqpt_type,eqpt_id,load_card,load_card_qty,program_card,program_card_qty,"
            + "total_quantity,box_no,gts_no,requested_by,"
            + "requestor_email,rack,shelf";

//    @Scheduled(cron = "0 25 15 * * *") //every 5 minutes !! inactive !!
//    public void UpdateAndClosedStencil() throws IOException {
//
//        //retrieve active stencil in sg gadut
//        WhRequestDAO requestD = new WhRequestDAO();
//        List<WhRequest> requestList = requestD.GetActiveStencilInInventory();
//
//        int count = 0;
//        for (int x = 0; x < requestList.size(); x++) {
//
//            //create new Retrieve request in WhRequest table
//            WhRequest newReq = new WhRequest();
//            newReq.setRequestType("Retrieve");
//            newReq.setRetrievalReason("Production");
//            newReq.setInventoryId(requestList.get(x).getInventoryId());
//            newReq.setEquipmentType(requestList.get(x).getEquipmentType());
//            newReq.setEquipmentId(requestList.get(x).getEquipmentId());
//            newReq.setPcbAQty("0");
//            newReq.setPcbBQty("0");
//            newReq.setPcbCQty("0");
//            newReq.setPcbCtrQty("0");
//            newReq.setLoadCardQty("0");
//            newReq.setProgramCardQty("0");
//            newReq.setQuantity(requestList.get(x).getQuantity());
//            newReq.setMpNo(requestList.get(x).getMpNo());
//            newReq.setMpExpiryDate(requestList.get(x).getMpExpiryDate());
//            newReq.setRack(requestList.get(x).getRack());
//            newReq.setShelf(requestList.get(x).getShelf());
//            newReq.setRequestedBy("Auto Retrieve");
//            newReq.setRemarks("Transfer to Sendayan Storage");
//            DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm");
//            Date date = new Date();
//            String formattedDate = dateFormat.format(date);
//            String RemarksLogFull = "[" + formattedDate + "] - Transfer to Sendayan Storage";
//            newReq.setRemarksLog(RemarksLogFull);
//            newReq.setCreatedBy("1");
//            newReq.setStatus("Closed");
//            newReq.setFlag("1");
//            newReq.setSfpkid("0");
//            newReq.setSfpkidB("0");
//            newReq.setSfpkidC("0");
//            newReq.setSfpkidCtr("0");
//            newReq.setSfpkidLc("0");
//            newReq.setSfpkidPc("0");
//            requestD = new WhRequestDAO();
//            QueryResult query1 = requestD.insertWhRequestAutoRetrieve(newReq);
//            if (query1.getGeneratedKey().equals("0")) {
//                LOGGER.info("step=request ;current inventory ID : " + requestList.get(x).getInventoryId());
//                break;
//            } else {
//                //new requestId
//                String newReqID = query1.getGeneratedKey();
//                //create new Retrieval in retrieval table
//                WhRetrieval retrieve = new WhRetrieval();
//                retrieve.setRequestId(newReqID);
//                retrieve.setHardwareType(requestList.get(x).getEquipmentType());
//                retrieve.setHardwareId(requestList.get(x).getEquipmentId());
//                retrieve.setHardwareQty(requestList.get(x).getQuantity());
//                retrieve.setRetrievalReason("Production");
//                retrieve.setPcbAQty("0");
//                retrieve.setPcbBQty("0");
//                retrieve.setPcbCQty("0");
//                retrieve.setPcbCtrQty("0");
//                retrieve.setLoadCardQty("0");
//                retrieve.setProgramCardQty("0");
//                retrieve.setMpNo(requestList.get(x).getMpNo());
//                retrieve.setMpExpiryDate(requestList.get(x).getMpExpiryDate());
//                retrieve.setRack(requestList.get(x).getRack());
//                retrieve.setShelf(requestList.get(x).getShelf());
//                retrieve.setRequestedBy("Auto Retrieve");
//                retrieve.setVerifiedBy("LSPT Instruments");
//                retrieve.setShippingBy("LSPT Instruments");
//                retrieve.setBarcodeVerification(requestList.get(x).getMpNo());
//                retrieve.setBarcodeVerifiedBy("Auto");
//                retrieve.setTtVerification(requestList.get(x).getEquipmentId());
//                retrieve.setTtVerifiedBy("Auto");
//                retrieve.setRemarks("Transfer to Sendayan Storage");
//                retrieve.setFlag("1");
//                retrieve.setStatus("Closed");
//
//                WhRetrievalDAO retD = new WhRetrievalDAO();
//                QueryResult resultRet = retD.insertWhRetrievalForAutoRetrieve(retrieve);
//                if (resultRet.getGeneratedKey().equals("0")) {
//                    LOGGER.info("step=retrieval ; current inventory ID : " + requestList.get(x).getInventoryId());
//                    break;
//                } else {
//                    //update inventory table
//                    WhInventory inventory = new WhInventory();
//                    inventory.setFlag("1");
//                    inventory.setRequestId(requestList.get(x).getId());
//                    inventory.setId(requestList.get(x).getInventoryId());
//                    WhInventoryDAO updateDAO = new WhInventoryDAO();
//                    QueryResult resultInv = updateDAO.updateWhInventoryFlag(inventory);
//                    if (resultInv.getResult() < 1) {
//                        LOGGER.info("step=updateInventory ; current inventory ID : " + requestList.get(x).getInventoryId());
//                        break;
//                    } else {
//                        //update old request table
//                        WhRequest oldReq = new WhRequest();
//                        oldReq.setStatus("Requested for Retrieval");
//                        oldReq.setFlag("1");
//                        oldReq.setId(requestList.get(x).getId());
//                        requestD = new WhRequestDAO();
//                        QueryResult resultOldReq = requestD.updateWhRequestStatusAndFlag1(oldReq);
//
//                        //update statusLog - Request
////                        WhStatusLog stat = new WhStatusLog();
////                        stat.setRequestId(newReqID);
////                        stat.setModule("cdars_wh_request");
////                        stat.setStatus("Requested for Retrieval");
////                        stat.setCreatedBy("Auto");
////                        stat.setFlag("0");
////                        WhStatusLogDAO statD = new WhStatusLogDAO();
////                        QueryResult queryResultStat = statD.insertWhStatusLog(stat);
//                        //update statusLog - Old Request [Shipment]
//                        WhStatusLog stat = new WhStatusLog();
//                        stat.setRequestId(requestList.get(x).getId());
//                        stat.setModule("cdars_wh_request");
//                        stat.setStatus("Requested for Retrieval");
//                        stat.setCreatedBy("Auto");
//                        stat.setFlag("0");
...
//                        QueryResult queryResultStat = statD.insertWhStatusLog(stat);
//
//                        //update statusLog - Shipped
//                        stat = new WhStatusLog();
//                        stat.setRequestId(newReqID);
//                        stat.setModule("cdars_wh_retrieval");
//                        stat.setStatus("Shipped From Seremban Factory");
//                        stat.setCreatedBy("Auto");
//                        stat.setFlag("0");
//                        statD = new WhStatusLogDAO();
//                        queryResultStat = statD.insertWhStatusLog(stat);
//
//                        //update statusLog - Received
//                        stat = new WhStatusLog();
//                        stat.setRequestId(newReqID);
//                        stat.setModule("cdars_wh_retrieval");
//                        stat.setStatus("Received");
//                        stat.setCreatedBy("Auto");
//                        stat.setFlag("0");
//                        statD = new WhStatusLogDAO();
//                        queryResultStat = statD.insertWhStatusLog(stat);
//
//                        //update statusLog - Closed
//                        stat = new WhStatusLog();
//                        stat.setRequestId(newReqID);
//                        stat.setModule("cdars_wh_retrieval");
...
//                        queryResultStat = statD.insertWhStatusLog(stat);
//
//                        if (resultOldReq.getResult() < 1) {
//                            LOGGER.info("step=oldRequest ; current inventory ID : " + requestList.get(x).getInventoryId());
//                            break;
//                        } else {
//                            //perform SPTS transaction and delete SF Item
//
////                            System.out.println("GET ITEM BY PARAM...");
//                            JSONObject params = new JSONObject();
//                            String itemID = requestList.get(x).getEquipmentId();
...
////                            DateFormat dateFormatSPTS = new SimpleDateFormat("yyyy-MM-dd");
//                            DateFormat dateFormatSPTS = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss.SSS");
//                            date = new Date();
//                            String formattedDateSPTS = dateFormatSPTS.format(date);
//                            String date1 = formattedDateSPTS.substring(0, 10);
//                            String time = formattedDateSPTS.substring(11, 23);
...
//                            params2.put("transQty", requestList.get(x).getQuantity());
...
//                                params3.put("pkID", requestList.get(x).getSfpkid());
...
//                                }
//                            } else {
//                                LOGGER.info("transaction failed item : " + requestList.get(x).getEquipmentId());
//                            }
//
//                        }
//
...
//            File file = new File("C:\\Users\\" + username + "\\Documents\\HMS\\hms_inventory.csv");
            File file = new File("\\\\mysed-rel-app03\\d$\\HIMS\\SF\\hms_inventory.csv");
...
//                csvReader = new CSVReader(new FileReader("C:\\Users\\" + username + "\\Documents\\HMS\\hms_inventory.csv"), ',', '"', 1);
                csvReader = new CSVReader(new FileReader("\\\\mysed-rel-app03\\d$\\HIMS\\SF\\hms_inventory.csv"), ',', '"', 1);
...
//                        insertftp.setMpExpiryDate(e.getMpExpiryDate());
                        insertftp.setMpNo(e.getBoxNo());
                        insertftp.setMpExpiryDate(e.getGtsNo());
                        ...
                        insertftp.setFlag("0");
                        QueryResult add = insertDao.insertWhInventoryNew(insertftp);
                        if (add.getResult() == 1) {
...
//            File fileRetrieval = new File("C:\\Users\\fg79cj\\Documents\\HMS\\hms_shipping.csv");
            File fileRetrieval = new File("\\\\mysed-rel-app03\\d$\\HIMS\\SF\\hms_shipping.csv");
...
//                CSVReader csvReaderForRetrieval = new CSVReader(new FileReader("C:\\Users\\" + username + "\\Documents\\HMS\\hms_shipping.csv"), ',', '"', 1);
                CSVReader csvReaderForRetrieval = new CSVReader(new FileReader("\\\\mysed-rel-app03\\d$\\HIMS\\SF\\hms_shipping.csv"), ',', '"', 1);
                ...
                while ((retrieval = csvReaderForRetrieval.readNext()) != null) {
                    ...
                    WhRetrievalTemp emp = new WhRetrievalTemp(retrieval[0],
                            ...
                            retrieval[5], retrieval[6], retrieval[7]); //7-->add box no
                    empList.add(emp);
                }
                ...
                for (WhRetrievalTemp e : empList) {
                    ...
                    //check with request ID + box ID first ; if none proceed with request ID + mp No
                    int countWithBoxId = retriveDao.getCountRequestIdAndBoxNo(e.getRequestId(), e.getBoxNo());
                    if (countWithBoxId == 1) {

                        WhRetrievalDAO idDao = new WhRetrievalDAO();
                        String id = idDao.getIdNew(e.getRequestId(), e.getBoxNo());
...
//    @Scheduled(cron = "0 49 11 * * *") //every 5 minutes !! inactive !!
...
//            File file = new File("\\\\mysed-rel-app03\\c$\\Users\\imperial\\Documents\\CDARS\\card_pairing.csv");
            File file = new File("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\card_pairing.csv");
...
//                csvReader = new CSVReader(new FileReader("\\\\mysed-rel-app03\\c$\\Users\\imperial\\Documents\\CDARS\\card_pairing.csv"), ',', '"', 1);
                csvReader = new CSVReader(new FileReader("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\card_pairing.csv"), ',', '"', 1);
...
//    @Scheduled(cron = "0 */15 * * * *") //every 15 minutes !! inactive !!
...
//            File file = new File("C:\\Users\\" + username + "\\Documents\\CDARS\\hims_eqp_data_migration.csv");
            File file = new File("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\hims_eqp_data_migration.csv");
...
//                csvReader = new CSVReader(new FileReader("C:\\Users\\" + username + "\\Documents\\CDARS\\hims_eqp_data_migration.csv"), ',', '"', 1);
                csvReader = new CSVReader(new FileReader("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\hims_eqp_data_migration.csv"), ',', '"', 1);
                //                csvReader = new CSVReader(new FileReader("D:\\DOTS\\RMS_FTP\\dots_rms_ftp.csv"), ',', '"', 1);
...
//                                File file1 = new File("C:\\Users\\" + username + "\\Documents\\CDARS\\hims_eqpt_migrate.csv");
                                File file1 = new File("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\hims_eqpt_migrate.csv");
...
//                                        fileWriter = new FileWriter("C:\\Users\\" + username + "\\Documents\\CDARS\\hims_eqpt_migrate.csv", true);
                                        fileWriter = new FileWriter("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\hims_eqpt_migrate.csv", true);
...
//                                        fileWriter = new FileWriter("C:\\Users\\" + username + "\\Documents\\CDARS\\hims_eqpt_migrate.csv");
                                        fileWriter = new FileWriter("\\\\mysed-rel-app03\\d$\\HIMS\\RL\\hims_eqpt_migrate.csv");
...
//    @Scheduled(cron = "0 */20 * * * *") //every 20 minutes !! inactive !!
//    @Scheduled(cron = "0 */7 * * * *") //every 7 minutes !! inactive !!
...
//                                            DateFormat dateFormatLc = new SimpleDateFormat("yyyy-MM-dd");
                                            DateFormat dateFormatLc = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss.SSS");
...
//                                            DateFormat dateFormatPc = new SimpleDateFormat("yyyy-MM-dd");
                                            DateFormat dateFormatPc = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss.SSS");
