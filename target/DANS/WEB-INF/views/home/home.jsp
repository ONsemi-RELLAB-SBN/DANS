                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-box clearfix">
                            ...
                            <hr/>
                            <p>Sorry, your ID is not registered with DANS, please contact our System Administrator for further help!</p>
                        </div>
                    </div>
                </div>
            </c:if>
        ...
        <script>
            ...
            <c:if test="${sessionScope.userSession.id != '0'}">
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    buttonText: {
//                        prev: '<box-icon name="left-arrow"></box-icon>'
//                        next: '<box-icon name="right-arrow"></box-icon>'
